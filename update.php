            ...
            <div class="row">
                <div class="col-6">
                    <div class="content">
                        ...
                        <input name="first_name" class="px-3 py-1" type="text" placeholder="First name"
                            value="<?php echo htmlspecialchars($row['first_name']) ?>">
                    </div>
                    <div class="content">
                        <label for="email_address">Email Address</label>
                        <input name="email_address" class="px-3 py-1" type="email" placeholder="Email Address"
                            value="<?php echo htmlspecialchars($row['email_address']) ?>">
                    </div>
                    <div class="content">
                        <label for="address">Address</label>
                        <input name="address" class="px-3 py-1" type="text" placeholder="Address"
                ...
                <div class="col-6">
                    <div class="content">
                        ...
                        <input name="last_name" class="px-3 py-1" type="text" placeholder="Last name"
                            value="<?php echo htmlspecialchars($row['last_name']) ?>">
                    </div>
                    <div class="content">
                        <label for="age">Age</label>
                        <input name="age" class="px-3 py-1" type="number" placeholder="Age"
