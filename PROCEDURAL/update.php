...
if (isset($_POST['submit'])) {
    ...
    if (!empty($errors)) {
        ...
        $sql = "UPDATE `user_registration` SET `first_name`='$first_name',`last_name`='$last_name',`email_address`='$email_address',`address`='$address',`age`='$age',`gender`='$gender' WHERE `id`=$id";
